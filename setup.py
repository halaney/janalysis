...
# Package meta-data.
NAME = 'janalysis'
DESCRIPTION = 'JPEG compression implementation and analysis for class.'
URL = 'https://github.com/tung44/janalysis'
...
setup(
    ...
    entry_points={
        "console_scripts": ["jpeg-encoder=janalysis.__main__:main"]
    },
